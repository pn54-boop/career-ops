...
Writing style is cached in `_profile.md` under `## Writing Style`. Use it directly — do not re-scan writing-samples unless the user explicitly asks to recalibrate.

Apply before generating any candidate-facing text (cover letters, outreach, form answers). Does NOT apply to internal evaluation reports.
