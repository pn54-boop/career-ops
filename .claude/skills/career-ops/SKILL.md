...
arguments: mode
user-invocable: true
argument-hint: "[scan | deep | pdf | oferta | ofertas | apply | batch | tracker | pipeline | contacto | training | project | interview-prep | patterns | followup]"
license: MIT
---
...
Available commands:
  ...
  /career-ops training       → Evaluate course/cert against your targets
