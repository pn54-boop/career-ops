...
const CANONICAL_REPO = 'https://github.com/pn54-boop/career-ops.git';
const RAW_VERSION_URL = 'https://raw.githubusercontent.com/pn54-boop/career-ops/main/VERSION';
const RELEASES_API = 'https://api.github.com/repos/pn54-boop/career-ops/releases/latest';
